...
<div class="page">
	<div class="container clearfix">
		...
		<div class="window clearfix">
			<div class="checkout">
				<ul>
					<li id="checkout-options">
			      <h2 class="checkout-heading"><?php echo $text_checkout_option; ?></h2>
			      <div class="checkout-content clearfix"></div>
					</li>
					<li id="payment-address">
						<h2 class="checkout-heading"><?php if (!$logged) { echo $text_checkout_account; } else { echo $text_checkout_payment_address; } ?></h2>
				    <div class="checkout-content"></div>
			  	</li>
			    <?php if ($shipping_required) { ?>
				    <li id="shipping-address">
				      <h2 class="checkout-heading"><?php echo $text_checkout_shipping_address; ?></h2>
				      <div class="checkout-content"></div>
				    </li>
				    <li id="shipping-method">
				      <h2 class="checkout-heading"><?php echo $text_checkout_shipping_method; ?></h2>
				      <div class="checkout-content"></div>
				    </li>
			    <?php } ?>
					<li id="payment-method">
					  <h2 class="checkout-heading"><?php echo $text_checkout_payment_method; ?></h2>
					 	<div class="checkout-content"></div>
					</li>
					<li id="confirm">
					  <h2 class="checkout-heading"><?php echo $text_checkout_confirm; ?></h2>
					  <div class="checkout-content"></div>
					</li>
				</ul>
			</div>
	...
	$('#button-account').live('click', function() {
		$.ajax({
			...
			success: function(html) {
				...
				$('.checkout .checkout-heading').append('<a class="edit"><?php echo $text_modify; ?></a>');
			},
			error: function(xhr, ajaxOptions, thrownError) {
				alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
			}
					...
					if (shipping_address) {
						$.ajax({
							...
							success: function(html) {
								...
								$('#shipping-address .checkout-heading').append('<a class="edit"><?php echo $text_modify; ?></a>');									
								$('#payment-address .checkout-heading').append('<a class="edit"><?php echo $text_modify; ?></a>');	
				...
				if (json['redirect']) {
					...
					$.ajax({
						...
						success: function(html) {
							...
							$('#payment-method .checkout-heading').append('<a class="edit"><?php echo $text_modify; ?></a>');	
						},
						error: function(xhr, ajaxOptions, thrownError) {
							alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
						}
